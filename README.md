...
concepts behind the shell program incluing the: process, system call, bit manipulation, file management and error handling ... </br>
Shell is a simple UNIX command interpreter that replicates functionalities of the simple shell (sh). </br>
Programming Language: C Language.
</p>

## COPYRIGHT
Copyright (C) 2023 by [**Winnie Ojwando**](https://github.com/Winnitta) </br>
All rights reserved
...
```
https://github.com/Winnitta/simple_shell.git
```
...
## Contributor :
* [**Winnie Ojwando**](https://github.com/Winnitta)
